      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <BrutalCard className="p-6 space-y-4 bg-surface">
          <div className="space-y-1 border-b-2 border-ink pb-3 mb-2">
            ...
            <p className="font-mono text-xs text-inkLight">Choose your authentication method below</p>
          </div>
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="font-mono text-[10px] font-normal opacity-70 mt-0.5">
                Instant access as pre-configured guest. No credentials needed. Judges: use this.
              </div>
            </div>
          </button>
          ...
          <p className="font-mono text-[10px] text-inkFaint text-center leading-relaxed pt-2">
            OAuth requires GOOGLE_CLIENT_ID / GITHUB_CLIENT_ID env vars on the server.<br />
            Guest mode bypasses all credentials for instant demo access.
          </p>
        </BrutalCard>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <ul className="font-mono text-[10px] text-inkLight space-y-1 list-disc list-inside">
                <li>Click "Quick Dev Bypass" for instant access (recommended for judges)</li>
                <li>After login, choose your persona: Student/Parent or Professional mode</li>
                <li>Navigate to INGEST and click "Load Demo Session" to populate all dashboards</li>
                <li>All widgets, Kanban boards, and charts will populate with realistic data</li>
              </ul>
            </div>
          </div>
        </BrutalCard>
